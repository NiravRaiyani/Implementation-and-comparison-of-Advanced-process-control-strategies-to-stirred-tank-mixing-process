...
for i=1:1:(tf/ts)
    V(i+1)  = V(i) + (-0.0075*V(i) + F1(i) + F2(i))*ts;
    rho(i+1)= rho(i) + (-0.015*rho(i) - 22.333*F1(i) + 44.667*F2(i))*ts;
    F1(i+1) = -(0.8313*V(i+1) - 0.0272*rho(i+1));
    F2(i+1) = -(0.5458*V(i+1) + 0.0416*rho(i+1));
    t(i+1)  = t(i) + ts;
end
figure(1)
...
for i=1:1:(tf/ts)
    V(i+1)  = V(i) + dV(i) + (-0.0075*V(i) + F1(i) + F2(i))*ts;
    rho(i+1)= rho(i) + drho(i) + (-0.015*rho(i) - 22.333*F1(i) + 44.667*F2(i))*ts;
    F1(i+1) = -(0.8313*V(i+1) - 0.0272*rho(i+1));
    F2(i+1) = -(0.5458*V(i+1) + 0.0416*rho(i+1));
    t(i+1)  = t(i) + ts;
end
